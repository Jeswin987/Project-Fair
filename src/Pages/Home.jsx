...
function Home() {
  ...
  return (
    <>
    {/* landing section */}
      <div style={{width:'100%',height:'100vh'}} className='container-fluid rounded bg-dark'>
...
       }
          ...
          <Col sm={12} md={6}>
            <img style={{marginTop:'100px'}} src="https://blog-cdn.lottiefiles.com/2022/04/YT-Change-Lottie-colors-with-JSON-Editor-and-VS-Code.png" alt="" className='w-75' />
          </Col>
        </Row>
      </div>
    {/*all projects  */}
